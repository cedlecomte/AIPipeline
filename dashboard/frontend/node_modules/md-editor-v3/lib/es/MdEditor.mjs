...
import { p as prefix, g as globalConfig, a as allToolbar, M as MinInputBoxWidth, b as allFooter } from "./chunks/config.mjs";
import { draggingScroll, linkTo, throttle, createSmoothScroll } from "@vavt/util";
import { a as Dropdown, D as DropdownToolbar } from "./chunks/index.mjs";
import { b as bus, C as CHANGE_FULL_SCREEN, E as ERROR_CATCHER, U as UPLOAD_IMAGE, O as OPEN_MODALS, R as REPLACE, a as CHANGE_CATALOG_VISIBLE, c as ON_SAVE, d as CTRL_SHIFT_Z, e as CTRL_Z, f as EVENT_LISTENER, T as TASK_STATE_CHANGED, S as SEND_EDITOR_VIEW, G as GET_EDITOR_VIEW } from "./chunks/event-name.mjs";
import { a as appendHandler } from "./chunks/dom.mjs";
import { C as CDN_IDS, c as contentProps, a as ContentPreview, e as editorEmits, b as editorProps, u as useProvide, d as useConfig, f as useCatalog, g as useOnSave, h as useExpansion, i as useErrorCatcher, j as useExpose, M as MdPreview } from "./chunks/index3.mjs";
import { M as MdModal, I as Icon } from "./chunks/index2.mjs";
import { b as base642File } from "./chunks/index5.mjs";
import { s as scrollAuto, a as scrollAutoWithScale, M as MdCatalog } from "./chunks/index4.mjs";
...
import { deleteLine, defaultKeymap, historyKeymap, indentWithTab, history, undo, redo } from "@codemirror/commands";
    ...
    const barRender = (barItem) => {
      ...
      if (allToolbar.includes(barItem)) {
        switch (barItem) {
          ...
          case "bold": {
            return createVNode("div", {
              "class": [`${prefix}-toolbar-item`, (disabled == null ? void 0 : disabled.value) && `${prefix}-disabled`],
          ...
          case "pageFullscreen": {
            return !props2.setting.fullscreen && createVNode("div", {
              "class": [`${prefix}-toolbar-item`, props2.setting.pageFullscreen && `${prefix}-toolbar-active`, (disabled == null ? void 0 : disabled.value) && `${prefix}-disabled`],
          ...
          case "fullscreen": {
            return createVNode("div", {
              "class": [`${prefix}-toolbar-item`, props2.setting.fullscreen && `${prefix}-toolbar-active`, (disabled == null ? void 0 : disabled.value) && `${prefix}-disabled`],
          ...
          case "preview": {
            return createVNode("div", {
              "class": [`${prefix}-toolbar-item`, props2.setting.preview && `${prefix}-toolbar-active`, (disabled == null ? void 0 : disabled.value) && `${prefix}-disabled`],
          ...
          case "previewOnly": {
            return createVNode("div", {
              "class": [`${prefix}-toolbar-item`, props2.setting.previewOnly && `${prefix}-toolbar-active`, (disabled == null ? void 0 : disabled.value) && `${prefix}-disabled`],
          ...
          case "htmlPreview": {
            return createVNode("div", {
              "class": [`${prefix}-toolbar-item`, props2.setting.htmlPreview && `${prefix}-toolbar-active`, (disabled == null ? void 0 : disabled.value) && `${prefix}-disabled`],
          ...
          case "catalog": {
            return createVNode("div", {
              "class": [`${prefix}-toolbar-item`, props2.catalogVisible && `${prefix}-toolbar-active`, (disabled == null ? void 0 : disabled.value) && `${prefix}-disabled`],
        ...
        if (defItem) {
          const defItemCloned = cloneVNode(defItem, {
            ...
            language: ((_xa = defItem.props) == null ? void 0 : _xa.theme) || language.value,
...
const handlePrettier = async (codeMirrorUt, params) => {
  var _a, _b, _c;
  const prettier = window.prettier || ((_a = globalConfig.editorExtensions.prettier) == null ? void 0 : _a.prettierInstance);
  const prettierPlugins = [
    ((_b = window.prettierPlugins) == null ? void 0 : _b.markdown) || ((_c = globalConfig.editorExtensions.prettier) == null ? void 0 : _c.parserMarkdownInstance)
  ];
...
const getSelectedInfo = (codeMirrorUt, options = { wholeLine: false }) => {
  ...
  return [
    state.doc.sliceString(selection2.from, selection2.to),
    selection2.from,
    selection2.to
  ];
};
...
const useCodeMirror = (props2) => {
  ...
  return {
    ...
    resetHistory() {
      var _a, _b;
      (_a = codeMirrorUt.value) == null ? void 0 : _a.view.dispatch({ effects: historyComp.reconfigure([]) });
      (_b = codeMirrorUt.value) == null ? void 0 : _b.view.dispatch({ effects: historyComp.reconfigure(history()) });
    }
  };
};
      ...
      return createVNode("div", {
        ...
        "onClick": (e, toc) => {
          ...
          if (!props2.setting.preview && toc.line !== void 0) {
            e.preventDefault();
            const view = (_a = codeMirrorUt.value) == null ? void 0 : _a.view;
            if (view) {
              const line = view.state.doc.line(toc.line + 1);
              const top = (_b = view.lineBlockAt(line.from)) == null ? void 0 : _b.top;
...
const Checkbox = /* @__PURE__ */ defineComponent({
  ...
  setup(props2) {
    return () => {
      return createVNode("div", {
        "class": [`${prefix}-checkbox`, props2.checked && `${prefix}-checkbox-checked`, props2.disabled && `${prefix}-disabled`],
        "onClick": () => {
          if (!props2.disabled) {
...
const ScrollAuto = /* @__PURE__ */ defineComponent({
  ...
  setup(props2) {
    ...
    return () => {
      var _a;
      return createVNode("div", {
        "class": [`${prefix}-footer-item`, (disabled == null ? void 0 : disabled.value) && `${prefix}-disabled`]
      }, [createVNode("label", {
        "class": `${prefix}-footer-label`,
        "onClick": () => {
          props2.onScrollAutoChange(!props2.scrollAuto);
        }
      }, [(_a = ult == null ? void 0 : ult.value.footer) == null ? void 0 : _a.scrollAuto]), createVNode(Checkbox, {
      ...
      if (allFooter.includes(name)) {
        ...
        if (defItem) {
          const defItemCloned = cloneVNode(defItem, {
            ...
            language: ((_b = defItem.props) == null ? void 0 : _b.language) || language.value,
        ...
        if (defItem) {
          const defItemCloned = cloneVNode(defItem, {
            ...
            language: ((_e = defItem.props) == null ? void 0 : _e.language) || language.value,
