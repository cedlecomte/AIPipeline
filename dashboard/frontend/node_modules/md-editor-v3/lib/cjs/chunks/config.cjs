...
const config = (option) => {
  return util.deepMerge(globalConfig, option, {
    excludeKeys(key) {
...
exports.MinInputBoxWidth = MinInputBoxWidth;
exports.allFooter = allFooter;
exports.allToolbar = allToolbar;
exports.codeCss = codeCss;
exports.config = config;
exports.editorExtensionsAttrs = editorExtensionsAttrs;
exports.globalConfig = globalConfig;
exports.prefix = prefix;
exports.staticTextDefault = staticTextDefault;
